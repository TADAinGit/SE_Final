...
namespace QUANLYQUAYTHUOC.AppForm
{
    public partial class MainForm : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        {
            commandBase = new TabControlCommand(tabControlMain, new InMaVachForm(), "In tem mã vạch");
            commandBase.Execute();
        }
        ...
        {
            commandBase = new TabControlCommand(tabControlMain, new LichSuBanHangForm(), "Lịch sử bán hàng");
            commandBase.Execute();
        }

        private void btnXemLichSuNhapHang_ItemClick(object sender, ItemClickEventArgs e)
        {
            commandBase = new TabControlCommand(tabControlMain, new LichSuNhapHangForm(), "Lịch sử nhập hàng");
            commandBase.Execute();
        }

        private void btnNhapHang_ItemClick(object sender, ItemClickEventArgs e)
        {
            commandBase = new TabControlCommand(tabControlMain, new NhapHangForm(), "Nhập hàng");
            commandBase.Execute();
        }
